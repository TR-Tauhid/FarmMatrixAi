...
const Loading = ({ theme = "light" }) => {
  ...
  return (
    ...
    >
      <div
        className={`relative flex flex-col items-center justify-center p-12 rounded-[2.5rem] shadow-2xl border ${isDark ? "bg-slate-900/60 border-slate-700/50" : "bg-white/60 border-white/50"} backdrop-blur-2xl overflow-hidden min-w-[320px]`}
      >
        {/* Decorative Glows */}
