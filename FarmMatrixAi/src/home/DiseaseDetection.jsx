    ...
    <section className="py-16 px-6 md:px-16 bg-emerald-50">
      <div className="max-w-4xl mx-auto bg-white p-8 rounded-xl shadow">
        ...
        <div className="mt-10 flex flex-col items-center">
          {!image && (
            <label className="w-full border-2 border-dashed border-emerald-400 rounded-xl p-10 text-center cursor-pointer hover:bg-emerald-100 transition">
              <p className="text-gray-700">{t("diseaseDetection.uploadPrompt")}</p>
          ...
          {image && (
            <div className="w-full">
              ...
              >
                {t("diseaseDetection.removeImage")}
              </button>
            </div>
          )}
        </div>
        ...
        <div className="mt-8 bg-gray-50 p-6 rounded-lg border">
          <h3 className="text-xl font-semibold text-gray-800">{t("diseaseDetection.resultTitle")}</h3>
